...
class ParametersFixed:
    def __init__(self, diagnostic, calibrate_mortality):

        # selected therapy
        self.diagnostic = diagnostic

        self.calibrate_mortality = calibrate_mortality
        ...
        # get rate matrix
        self.rateMatrix = get_rate_matrix(self.diagnostic, self.calibrate_mortality)
...
def get_rate_matrix(diagnostic, calibrate_mortality):
